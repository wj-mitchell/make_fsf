...
set fmri(paradigm_hp) 1500

# Total voxels
set fmri(totalVoxels) 246921675
...
set feat_files(1) "/data/Uncertainty/data/deriv/pipeline_1/fmriprep/sub-0295/func/sub-0295_task-uncertainty_run-1_space-MNI152NLin2009cAsym_desc-preproc_bold"

# Add confound EVs text file
set fmri(confoundevs) 1

# Confound EVs text file for analysis 1
set confoundev_files(1) "/data/Uncertainty/data/deriv/pipeline_1/fmriprep/sub-0295/func/sub-0295_task-uncertainty_run-1_desc-confounds_timeseries_reduced.tsv"

# EV 1 title
set fmri(evtitle1) "Rating"
...
# Custom EV file (EV 1)
set fmri(custom1) "/data/Uncertainty/data/deriv/pipeline_1/fmriprep/sub-0295/onset/sub-0295_task-Run1_rating.txt"
...
# Custom EV file (EV 2)
set fmri(custom2) "/data/Uncertainty/data/deriv/pipeline_1/fmriprep/sub-0295/onset/sub-0295_task-Run1_notrating.txt"
...
# Custom EV file (EV 3)
set fmri(custom3) "/data/Uncertainty/data/deriv/pipeline_1/fmriprep/sub-0295/onset/sub-0295_task-Run1_paramod.txt"
...
set fmri(conname_real.1) "Rating > Baseline"
...
set fmri(conname_real.2) "Not Rating > Baseline"
...
set fmri(conname_real.3) "Rating > Not Rating"
...
set fmri(conname_real.4) "Not Rating > Rating"
...
set fmri(conname_real.5) "Paramod"
...
set fmri(conname_orig.1) "Rating > Baseline"
...
set fmri(conname_orig.2) "Not Rating > Baseline"
...
set fmri(conname_orig.3) "Rating > Not Rating"
...
set fmri(conname_orig.4) "Not Rating > Rating"
...
set fmri(conname_orig.5) "Paramod"
